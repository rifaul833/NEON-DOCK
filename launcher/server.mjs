...
const GAMES = [
  ...
  },
  {
    ...
    controls: "Left / Right",
    accent: "#7cffb2",
    cwd: path.join(ROOT, "javascript-racer"),
    port: 4107,
    kind: "static",
    entry: "v4.final.html",
    cover: path.join(PUBLIC, "covers", "highway.png"),
  },
  {
    id: "ludo",
    title: "Ludo",
  ...
  },
  {
    ...
    controls: "Arrows / A D",
    accent: "#ff8a3d",
    cwd: path.join(ROOT, "Racing-Bike", "Racing-Bike"),
    port: 4110,
    kind: "vinext",
    cover: path.join(PUBLIC, "covers", "cycling.png"),
  },
];
